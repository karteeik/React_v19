...
export const useMyData = () => {
  // const MyCustomHook = useContext(NameContext);
  const MyCustomHook = use(NameContext);  // use api using conditional hook provide

  if (MyCustomHook == undefined) {
    throw new Error("Component Must be wrapped with NameProvider");
  }
  return MyCustomHook;
};
